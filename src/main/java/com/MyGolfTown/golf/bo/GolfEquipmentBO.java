...
public class GolfEquipmentBO {
	...
	public GolfEquipment getGolfEquipmentByIdEquipmentType(int Id, String equipmentType){
		return golfEquipmentMapper.selectGolfEquipmentByIdEquipmentType(Id,equipmentType);
	}
